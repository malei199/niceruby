  		...
  		<div class="m-detailwrap">
		      ...
		      <div class="m-section f-cb">
		        ...
		        <div class="content f-fl">
		          ...
		          <p class="sponsor" style="display:none;"><em class="pos">协办</em>{{activityData.coSponsor}}</p>
		        </div>
		      </div>
		    </div>
...
<style lang="scss" scoped>
	.activitypreview{
		.g-section{width:1000px; margin:0 auto; padding:25px 0;
			.m-title{height:16px;
			...
			.m-detailwrap{margin-top:30px; border-radius:6px;
				.m-top{width:998px; background:#fff; margin:0 auto; border-radius:6px; box-shadow: 0 0 12px rgba(0, 0, 0, 0.05); border:1px solid #e3e9ee;
		      .m-section{position:relative; padding:29px;
		        .m-img{position:relative;
		          .cover{width:183px; height:251px;}
		          .tag{position:absolute; top:-7px; left:-7px; z-index:99;}
		        }
		        .content{margin-left:30px; text-align:left;
		          h3{font-size:24px; color:#3b4857; height:40px; line-height:40px; font-weight:bold; max-width:660px; overflow: hidden; text-overflow:ellipsis; white-space:nowrap;}
		          .keywords {margin: 25px 0 45px 0;
							  span {
							  	font-size: 14px;color: #c51e60;padding: 6px 15px;background: #fbeff4;border: 1px solid #c51e60;border-radius: 8px;
							  	margin-right: 7px;
							  }
							}
		    ...
		    .m-pagecontent{width:998px; margin-top:20px; box-shadow: 0 0 12px rgba(0, 0, 0, 0.05); border:1px solid #e3e9ee; border-radius:6px;
	        .m-activitydetail{
	          li{
	            .paperblock{background:#f8fafb; font-size:16px; color:#3b4857; font-weight:bold; border-top:1px solid #e3e9ee; border-bottom:1px solid #e3e9ee; height:22px; line-height:22px; padding:15px 0;
	              p{background:url('../../images/activityIcon.png') no-repeat; padding-left:50px;
	                &.detail{background-position:27px -96px;}
	                &.guest{background-position:27px -119px;}
	                &.process{background-position:27px -142px;}
	                &.number{background-position:27px -164px;}
	                &.comments{background-position:27px -187px;}
	              }
	            }
	            .papercontent{position:relative; background:#fff;
	              ...
	              .swiper-area{padding:30px 50px 40px 50px;
	                ...
	                .position{font-size:12px; line-height:12px; color:#99a9be; width:140px; text-align:center;}
	                ...
	                .swiper-container{margin-left:20px;}
	                .swiper-button-next, .swiper-button-prev{top:130px;}
	                
	              }
	              .guestopenbox{width:790px;min-height:300px;border:4px solid #c0ccda;border-radius: 8px;margin-top:-4px;padding:50px 54px 50px 49px;margin-bottom:2px;
	              ...
	              .process-area{padding:1px 50px 46px 46px;
	                ...
	                .item{border:1px solid #e9ecf2; background:#f8fafb; border-radius:7px; padding:19px 32px; overflow:hidden;
	                  .process-time{font-size:20px; color:#aab5c1; line-height:20px;}
	                  .process-content{font-size:16px; color:#3b4857; line-height:20px; background:url(../../images/activityIcon.png) no-repeat 39px -232px; padding-left:210px; width:442px; text-align:justify;}
	                }
	              }
	              .person-area{padding:35px 49px 5px 50px; overflow:hidden;
	                dd{ position:relative; width:107px; float:left; margin:0 71px 25px 0;
	                  .avatar{display:block; width:99px; height:99px; border:4px solid #e9eff2; border-radius:54px;}
	                  .name{font-size:16px; line-height:46px; color:#3b4857; width:107px; text-align:center; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;}
	      ...
	      .conbottom{width:100%;height:90px;background-color:#fff;}
        .goback{display:inline-block; width:138px; height:48px; font-size:16px; line-height:48px; text-align:center; border:1px solid #ccd4f7; border-radius:5px; 
        	margin:0 0 0 430px;background:#5771e6; color:#fff;
				}
			}
		}
	}
